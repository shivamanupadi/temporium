...
function TransactionCard({ transaction }: { transaction: ScheduledTransaction }) {
...
function StatusBadge({ status, isPastSchedule }: { status: string; isPastSchedule: boolean }) {
...
function CountdownTimer({ scheduledFor }: { scheduledFor: number }) {
