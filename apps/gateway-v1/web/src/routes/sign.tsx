            ...
            <div className="bg-white rounded-2xl border border-[#EDE9E3] shadow-sm overflow-hidden">
              ...
              {disconnectedAppInfo && (
                <div className="px-6 py-4">
                  <div className="flex items-center gap-3 px-4 py-3 bg-[#FDFBF8] rounded-xl border border-[#EDE9E3]">
                    <div className="w-10 h-10 rounded-xl bg-[#F5F2ED] border border-[#EDE9E3] flex items-center justify-center shrink-0">
