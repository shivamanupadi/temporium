    ...
    <>
      ...
      <div className="lg:flex lg:gap-6 lg:items-stretch">
        ...
        <div className="lg:flex-[3]">
          ...
          <div className="bg-[var(--color-sage)]/10 rounded-2xl p-6 mb-6">
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-2xl bg-card shadow-sm flex items-center justify-center">
                  <HandCoins className="h-8 w-8 text-[var(--color-sage)]" />
                </div>
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <span
                      className={`text-[12px] font-medium px-2 py-0.5 rounded-full ${
                        isOptedIn
                          ? 'text-[var(--color-sage)] bg-[var(--color-sage)]/15'
            ...
            <div className="flex gap-3">
              <Button
                ...
                className="flex-1 h-11 bg-[var(--color-sage)] hover:bg-[var(--color-sage)]/90"
              >
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <div className="bg-card rounded-xl p-4 shadow-xs border border-border">
              ...
              <p
                className={`text-xl font-bold mt-1 ${isOptedIn ? 'text-[var(--color-sage)]' : 'text-muted-foreground'}`}
              >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-[var(--color-sage)]/15 flex items-center justify-center">
                      <UserCheck className="h-5 w-5 text-[var(--color-sage)]" />
                    </div>
                    <div>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    >
                      {copiedRecipient ? (
                        <Check className="h-4 w-4 text-[var(--color-sage)]" />
                      ) : (
          ...
          <div className="bg-card rounded-xl p-4 shadow-xs border border-border">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-[var(--color-sage)]/15 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-[11px] font-semibold text-[var(--color-sage)]">1</span>
                </div>
                <div>
              ...
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-[var(--color-sage)]/15 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-[11px] font-semibold text-[var(--color-sage)]">2</span>
                </div>
                <div>
              ...
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-[var(--color-sage)]/15 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-[11px] font-semibold text-[var(--color-sage)]">3</span>
                </div>
                <div>
