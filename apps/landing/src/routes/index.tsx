...
function HomePage(): ReactElement {
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      {/* Hero Section */}
      <section
        className="relative pt-32 pb-20 md:pt-40 md:pb-28 px-6 bg-white overflow-hidden"
        style={{
          backgroundImage: `
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              {/* Main Heading */}
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 text-slate-900 leading-[1.1] tracking-tight">
                Your Tools for
                <br />
                Tempo Blockchain
              </h1>
              ...
              {/* Description */}
              <p className="text-lg md:text-xl text-slate-600 mb-8 leading-relaxed font-light max-w-lg">
                Everything you need to interact with Tempo. Manage your wallet or run your own
                infrastructure node.
              </p>

              {/* Trust indicators */}
              <div className="flex flex-wrap items-center gap-6 mb-10 text-sm font-medium text-slate-700">
            ...
            >
                ...
                <div className="relative bg-white border border-slate-200/80 rounded-2xl p-8 hover:border-slate-300 transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                  <div className="flex items-start gap-5">
                    <div className="mt-0.5">
                      <div className="w-14 h-14 rounded-xl bg-[#7c5cff]/15 flex items-center justify-center">
                        <Wallet className="w-7 h-7 text-[#7c5cff]" strokeWidth={2} />
                      </div>
                    </div>
              ...
              <a href={NODE_MANAGER_URL} className="block group">
                <div className="relative bg-white border border-slate-200/80 rounded-2xl p-8 hover:border-slate-300 transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                  <div className="flex items-start gap-5">
                    <div className="mt-0.5">
                      <div className="w-14 h-14 rounded-xl bg-[#0073e6]/15 flex items-center justify-center">
                        <Server className="w-7 h-7 text-[#0073e6]" strokeWidth={2} />
                      </div>
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-2">
      ...
      {/* Footer */}
      <footer className="mt-auto px-6 py-8 border-t border-slate-100">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="text-[13px] text-slate-400">Fast, secure, and simple.</div>
        </div>
      </footer>
    </div>
  );
