  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-[13px] text-[#9B9590] mt-1">Manage apps connected to your wallet</p>
      </div>
      ...
      <div className="text-center py-16 bg-white border border-[#EDE9E3] rounded-2xl">
        ...
        <p className="text-[13px] text-[#9B9590] mt-1 max-w-sm mx-auto">
          External apps will be able to connect to the gateway and submit transactions through your
          wallet.
        </p>
      </div>

      {/* Hidden: original connected apps UI — preserved for future use */}
      {false && (
        <>
          {/* Tabs */}
                    ...
                    {filteredActivity.length === 0 ? (
                      ...
                      visibleActivity.map((item, index) => (
                        ...
                        >
                          ...
                          {/* App */}
                          <span className="text-[12px] text-[#9B9590] truncate">
                            {item.appName}
                          </span>
            ...
            <DialogContent className="max-w-[360px] p-0 gap-0 rounded-2xl">
              <div className="px-6 pt-6 pb-4">
                ...
                <DialogDescription className="text-[13px] text-[#9B9590]">
                  ...
                  <strong className="text-[#2D3436]">{revokeTarget?.name}</strong>? The app will
                  need to reconnect to interact with your wallet.
                </DialogDescription>
              </div>
