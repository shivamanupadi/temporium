...
export function LinkTokenModal({
  ...
  const handleSubmit = useCallback(async (): Promise<void> => {
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : 'Failed to link policy to token';
      toast.error(message);
    } finally {
      setIsSubmitting(false);
      isSubmittingRef.current = false;
    }
  }, [tokenAddress, policyId, feeToken, linkToToken, onSuccess]);
        ...
        {modalState === 'input' && (
          <>
            <div className="px-6 pt-6 pb-5 pr-14">
              <DialogTitle className="text-lg font-bold text-[#2D3436]">Link to Token</DialogTitle>
        ...
        {modalState === 'confirm' && tokenMetadata && (
          <>
            <div className="px-6 pt-6 pb-5 pr-14">
              ...
              <DialogDescription className="text-[13px] font-light text-[#9B9590]">
                Review details before applying the policy
              </DialogDescription>
            </div>
        ...
        {modalState === 'success' && tokenMetadata && (
          <>
            ...
            <div className="px-6 pt-10 pb-6 text-center">
              ...
              {/* Title */}
              <p className="text-[15px] font-bold text-[#2D3436] mb-1">Policy Applied!</p>
