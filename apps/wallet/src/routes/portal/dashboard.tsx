    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          {/* Assets */}
          <div>
            <h2 className="text-[13px] font-medium text-gray-500 uppercase tracking-wider mb-3 px-1">Assets</h2>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-[0_0_0_1px_rgba(0,0,0,0.03),0_1px_2px_-1px_rgba(0,0,0,0.03)] p-4">
            <h2 className="text-[13px] font-medium text-gray-500 uppercase tracking-wider mb-3">Quick Actions</h2>
