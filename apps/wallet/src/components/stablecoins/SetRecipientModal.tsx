          ...
          {txHash ? (
            ...
            <>
              ...
              <div className="flex gap-2 mt-4">
                ...
                <Button
                  className={`flex-1 h-10 ${isOptIn ? 'bg-emerald-600 hover:bg-emerald-700 shadow-[0_1px_2px_0_rgba(0,0,0,0.05),0_0_0_1px_rgba(5,150,105,1)] hover:shadow-[0_3px_8px_0_rgba(5,150,105,0.25),0_0_0_1px_rgba(5,150,105,1)]' : 'bg-amber-500 hover:bg-amber-600 shadow-[0_1px_2px_0_rgba(0,0,0,0.05),0_0_0_1px_rgba(245,158,11,1)] hover:shadow-[0_3px_8px_0_rgba(245,158,11,0.25),0_0_0_1px_rgba(245,158,11,1)]'}`}
