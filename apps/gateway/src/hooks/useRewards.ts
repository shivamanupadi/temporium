...
// Query key for rewards - used for cache invalidation
...
export function useRewards({ token }: UseRewardsParams): UseRewardsReturn {
  ...
  // Start reward distribution (any user with tokens can distribute)
  ...
  // Set reward recipient (opt-in or opt-out)
